...
const CreateTextbookSectionsButtons = observer(
  ({
    onClickSectionHardButton,
  }: {
    onClickSectionHardButton: (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => void
  }) => {
        ...
        <li className={styles['textbook-sections__list']}>
          <button
            ...
            className={`${styles.textbook__link} ${
              INDEX_STAR_SECTION_BUTTON === vocabulary.page ? styles['textbook__link_active'] : ''
            }`}
            onClick={onClickSectionHardButton}
          >
            <svg
              width='40'
              height='39'
