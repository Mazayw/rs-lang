...
export function Word({
  ...
  gramophoneButtonDisabled: boolean
  setGramophoneButtonDisabled: React.Dispatch<React.SetStateAction<boolean>>
}) {
    ...
    >
      ...
      <div className={styles['word-card__content']}>
        ...
        <p className={styles['word-translate']}>
          {wordTranslate}
          <span className={styles['word-transcription']}>{transcription}</span>
        </p>
      ...
      >
        <button
          ...
          onClick={(e) => ClickStudiedWord(e, id || _id)}
        >
          <svg
            width='40'
            height='40'
          ...
          >
            <g id='#000000ff'>
              <path
                fill={easyWordsId.includes(id || _id) ? '#F5443B' : '#171836'}
                opacity='1.00'
        ...
        <button
          ...
          onClick={(e) => ClickHardWord(e, id || _id)}
        >
          <svg
            width='40'
            height='39'
          ...
          >
            <path
              ...
              fill={hardWordsId.includes(id || _id) ? '#F5443B' : '#171836'}
            />
          </svg>
        </button>
      </div>
