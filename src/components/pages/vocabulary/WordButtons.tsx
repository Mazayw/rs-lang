  ...
  return (
    <ul className={styles['word-buttons']}>
      {words.map((word, index) =>
        <li key={index} className={styles['word-button-list']}>
          <button className={`${styles['word-button']} ${index === buttonWordCurrentIndex ? styles['word-button_active'] : ''}`} onClick={(e) => clickWordButtons(e, index)}>
