...
export function WordButtons({
  ...
  words: IWord[]
  buttonWordCurrentIndex: number
  clickWordButtons: (e: React.MouseEvent<HTMLButtonElement, MouseEvent>, index: number) => void
  hardWordsId: string[]
  easyWordsId: string[]
  token: string
}) {
        ...
        <li key={index} className={styles['word-button-list']}>
          <button
            className={`${styles['word-button']} ${
              index === buttonWordCurrentIndex ? styles['word-button_active'] : ''
            }`}
            onClick={(e) => clickWordButtons(e, index)}
          >
            ...
            <span
              className={`${styles['word-button-container-icon']} ${
                token ? styles['word-button-container-icon_active'] : ''
              }`}
            >
              <svg
                width='19pt'
              ...
              >
                <g id='#000000ff'>
                  <path
                    fill={easyWordsId.includes(word.id || word._id) ? '#F5443B' : '#171836'}
                    opacity='1.00'
